...
class CoinPage(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.summary_frame = ctk.CTkFrame(self, corner_radius=15, fg_color="transparent")
        ...
        self.total_label_title = ctk.CTkLabel(self.total_container, text="Total to Pay", font=("Roboto", 14))
